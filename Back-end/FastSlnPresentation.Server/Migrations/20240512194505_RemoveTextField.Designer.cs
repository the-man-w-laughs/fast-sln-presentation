...
namespace FastSlnPresentation.Server.Migrations
{
    ...
    [Migration("20240512194505_RemoveTextField")]
    partial class RemoveTextField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FastSlnPresentation.DAL.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 5, 12, 22, 45, 5, 236, DateTimeKind.Local).AddTicks(3217),
                            Email = "admin@the.best",
                            Name = "Admin",
                            PasswordHash = "Q0NgcFYKIt9iElgEdR0j4UWUpJ1yUHJMN9kSKW57z2Q=",
                            RoleId = 1,
                            Salt = "/IYF//dXJYzDjzljXticqQ=="
                        });
                });
